...
public final class EchoHandler implements IDataHandler, IConnectionTimeoutHandler, IIdleTimeoutHandler, ILifeCycle {
	...
	public EchoHandler(int delay, boolean syncFlush, boolean writeTofile) throws IOException {
		this.delay = delay;
