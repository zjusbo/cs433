...
*/
public final class SmtpJavaMailTest {

	
	@Test public void testCommandOrder() throws Exception {		
		IMultithreadedServer server = new MultithreadedServer(new SmtpProtocolHandler(new DummyMessageSinkService(MODE.DEV0OUT), null, null));
