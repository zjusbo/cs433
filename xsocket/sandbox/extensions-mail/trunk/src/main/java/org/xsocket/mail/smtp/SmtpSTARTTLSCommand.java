...
final class SmtpSTARTTLSCommand extends SmtpCommand {
	
	private static final Logger LOG = Logger.getLogger(SmtpSTARTTLSCommand.class.getName());
	...
	public void execute(INonBlockingConnection connection, ISmtpSession session, String argument) throws IOException {
		sendResponse(connection, "220 Go ahead");
