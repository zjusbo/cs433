...
public interface IMultiplexedConnection extends IConnection {
	 ...
	 * @return the pipeline
	 * @throws ClosedException if the pipeline is already closed or does not exist
	 */
	INonBlockingPipeline getNonBlockingPipeline(String pipelineId) throws ClosedException;
	 ...
	 * @throws ClosedException if the pipeline is already closed or does not exist
	 */
	IBlockingPipeline getBlockingPipeline(String pipelineId) throws ClosedException;
