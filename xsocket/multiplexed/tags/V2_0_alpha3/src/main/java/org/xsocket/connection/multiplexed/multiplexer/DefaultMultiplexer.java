...
/**
 * the default implementation of the {@link IMultiplexer} 
 * 
...
public final class DefaultMultiplexer implements IMultiplexer {
	 ...
	 * {@inheritDoc}
	 */
	public String openPipeline(INonBlockingConnection connection) throws IOException, ClosedException {
	 ...
	 * {@inheritDoc}
	 */
	public void closePipeline(INonBlockingConnection connection, String pipelineId) throws IOException, ClosedException {
		if (LOG.isLoggable(Level.FINE)) {
	 ...
	 * {@inheritDoc}
	 */
	public void multiplex(INonBlockingConnection connection, String pipelineId, ByteBuffer[] dataToWrite) throws IOException, ClosedException {
		int dataLength = 0;
	 ...
	 * {@inheritDoc}
	 */
	public void demultiplex(INonBlockingConnection connection, IDemultiplexResultHandler resultHandler) throws IOException, ClosedException {
		byte dataType = 0;
