...
public final class DataConverter {
	...
	static {
		RFC822_DATE_FORMAT.setCalendar(Calendar.getInstance(TimeZone.getTimeZone("GMT+0")));
	...
	public static String toFormatedRFC822Date(long time) {
		return RFC822_DATE_FORMAT.format(time);
	}
	...
	public static Date toDate(String rfc822DateString) {
		try {
			return RFC822_DATE_FORMAT.parse(rfc822DateString);
