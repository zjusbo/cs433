// $Id: NonBlockingConnection.java 1878 2007-11-12 16:22:15Z grro $
/*
...
public final class NonBlockingConnection extends Connection implements INonBlockingConnection {
	...
	public NonBlockingConnection(InetAddress address, int port, SSLContext sslContext, boolean sslOn, IHandler appHandler) throws IOException {
		this(new InetSocketAddress(address, port), new HashMap<String, Object>(), sslContext, sslOn, appHandler, null);
	}

	
	public NonBlockingConnection(InetAddress address, int port, SSLContext sslContext, boolean sslOn, IHandler appHandler, Executor workerpool) throws IOException {
		this(new InetSocketAddress(address, port), new HashMap<String, Object>(), sslContext, sslOn, appHandler, workerpool);
	}
