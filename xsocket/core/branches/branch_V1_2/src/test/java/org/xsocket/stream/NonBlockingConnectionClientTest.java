// $Id: NonBlockingConnectionClientTest.java 1769 2007-09-26 07:24:59Z grro $
/*
...
public final class NonBlockingConnectionClientTest {
	...
	public void testSimple() throws Exception {
		...
		SendTask sendTask = new SendTask(InetAddress.getByName("localhost"), testServer.getLocalPort(), "testi@xsocket.de");
		do {
			sendTask.perform();
