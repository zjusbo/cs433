...
public final class ServerPush  {
	...
	public static void main(String... args) throws Exception {
		IMultithreadedServer server = new MultithreadedServer(0, new Handler());
	...
	private static final class Notifier extends TimerTask {
		...
		public void run() {
			try {
				...
				System.out.println("error occured by sending pong to " + connection.getRemoteAddress().getHostAddress() + ":" + connection.getRemotePort());
			}
		}
	}	
}
