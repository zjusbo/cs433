...
public final class SSLUserActivatedTest {
	...
	public void testRepeatedActivation() throws Exception {
		...
		IMultithreadedServer sslTestServer = new MultithreadedServer(0, new SSLHandlerRepeatedActivation(), false, SSLTestContextFactory.getSSLContext());
	...
	public void testActivateSslOnConnect() throws Exception {
		...
		IMultithreadedServer sslTestServer = new MultithreadedServer(0, new OnConnectSSLHandler(), false, SSLTestContextFactory.getSSLContext());
		StreamUtils.start(sslTestServer);
       
		sslContext = SSLTestContextFactory.getSSLContext();
	...
	public void testActivateSslOnConnect2() throws Exception {
		...
		IMultithreadedServer sslTestServer = new MultithreadedServer(0, new OnConnectSSLHandler2(), false, SSLTestContextFactory.getSSLContext());
		StreamUtils.start(sslTestServer);
	...
	public void testActivateSslOnConnect3() throws Exception {
		...
		IMultithreadedServer sslTestServer = new MultithreadedServer(0, new OnConnectSSLHandler3(), false, SSLTestContextFactory.getSSLContext());
		StreamUtils.start(sslTestServer);
	...
	public void testActivateSslOnConnect4() throws Exception {
		...
		IMultithreadedServer sslTestServer = new MultithreadedServer(0, new OnConnectSSLHandler4(), false, SSLTestContextFactory.getSSLContext());
		StreamUtils.start(sslTestServer);
	...
	public void testBlocking() throws Exception {
		...
		IMultithreadedServer sslTestServer = new MultithreadedServer(0, new AdHocSSLHandler(), false, SSLTestContextFactory.getSSLContext());
		StreamUtils.start(sslTestServer);
	...
	public void testLengthField() throws Exception {
		...
		IMultithreadedServer sslTestServer = new MultithreadedServer(0, new OnConnectLengthFieldHandler(), false, SSLTestContextFactory.getSSLContext());
		StreamUtils.start(sslTestServer);
