...
public class MultithreadedServer implements IMultithreadedServer {
	...
	private void newConnection(SocketChannel sc) throws IOException {
		if (sc != null) {
			NonBlockingConnectionImpl connection = newNonBlockingConnectionImpl(sc, generatedId());
	...
	protected NonBlockingConnectionImpl newNonBlockingConnectionImpl(SocketChannel sc, String id) throws IOException {
		return new NonBlockingConnectionImpl(sc, id);
	}
	 ...
	 * @see IMultithreadedServer
	 */
	public final synchronized void setHandler(IHandler handler) {
	 ...
	 * @see IMultithreadedServer
	 */
	public final List<Dispatcher> getDispatcher() {
		return dispatchers;
	}
	 ...
	 * @see IMultithreadedServer
	 */
	public final synchronized void setDispatcherSize(int size) {
		dispatcherSize = size;
	 ...
	 * @see IMultithreadedServer
	 */
	public synchronized final int getDispatcherSize() {
	 ...
	 * @see IMultithreadedServer
	 */
	public final synchronized void setDispatcherWorkerSize(int size) {
	 ...
	 * @see IMultithreadedServer
	 */
	public synchronized final int getDispatcherWorkerSize() {
	 ...
	 * @see IMultithreadedServer
	 */
	public final void setReceivingTimeout(long timeout) {
