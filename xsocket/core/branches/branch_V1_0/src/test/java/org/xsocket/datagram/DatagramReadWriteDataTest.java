// $Id: DatagramReadWriteDataTest.java 1108 2007-03-29 16:44:02Z grro $
/*
...
public final class DatagramReadWriteDataTest {
	...
	@Test public void testDataTypes() throws Exception {		
		...
		byte[] data = QAUtil.generatedByteArray(10);
		packet.write(data);
		byte[] data2 = QAUtil.generatedByteArray(17);
		...
		byte[] data3 = QAUtil.generatedByteArray(4);
		packet.write(data3);
	...
	@Test public void testMaxReadSize() throws Exception {		
		...
		packet.write(QAUtil.generatedByteArray(10));
