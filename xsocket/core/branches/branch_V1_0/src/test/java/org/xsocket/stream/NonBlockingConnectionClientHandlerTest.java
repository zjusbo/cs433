// $Id: NonBlockingConnectionClientHandlerTest.java 1108 2007-03-29 16:44:02Z grro $
/*
...
public final class NonBlockingConnectionClientHandlerTest {
	...
	@Test public void testConnectAndDisconnect() throws Exception {
	...
	@Test public void testServerInitiatedClose() throws Exception {
		IMultithreadedServer testServer = new MultithreadedServer(new ServerHandler());
		new Thread(testServer).start();
	...
	@Test public void testChainTest() throws Exception {
		IMultithreadedServer testServer = new MultithreadedServer(new ServerHandler());
		new Thread(testServer).start();
	...
	@Test public void testCustomWorkerPool() throws Exception {
		IMultithreadedServer testServer = new MultithreadedServer(new ServerHandler());
		new Thread(testServer).start();

		ClientDataHandler clientDataHandler = new ClientDataHandler();
		WorkerPool workerPool = new WorkerPool();
		INonBlockingConnection connection = new NonBlockingConnection(testServer.getLocalAddress(), testServer.getLocalPort(), clientDataHandler, workerPool, 4096);
		connection.setAutoflush(true);
	...
	private static final class WorkerPool implements IWorkerPool {
