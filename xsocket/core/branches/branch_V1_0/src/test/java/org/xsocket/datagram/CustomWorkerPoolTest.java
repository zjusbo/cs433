// $Id: CustomWorkerPoolTest.java 1108 2007-03-29 16:44:02Z grro $
/*
...
public final class CustomWorkerPoolTest {
	...
	@Test public void testCustomWorkerPool() throws Exception {
		...
		IEndpoint eServer = new Endpoint(packageSize, hdl);
		WorkerPool workerPool = new WorkerPool();
		eServer.setWorkerPool(workerPool);
		...
		for (int i = 0; i < loops; i++) {
			...
			UserDatagram packet = new UserDatagram(eServer.getLocalSocketAddress(), data);
		...
		Assert.assertTrue(workerPool.created == loops);
