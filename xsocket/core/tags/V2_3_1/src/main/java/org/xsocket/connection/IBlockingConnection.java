...
public interface IBlockingConnection extends IConnection, IDataSource, IDataSink, GatheringByteChannel, ReadableByteChannel, WritableByteChannel, Flushable {
	...
	/**
	 * @deprecated replaced by {@link IBlockingConnection#DEFAULT_READ_TIMEOUT}
	 */
	public static final int DEFAULT_RECEIVE_TIMEOUT = DEFAULT_READ_TIMEOUT;
	 ...
	 */
	void setReceiveTimeoutMillis(int timeout) throws IOException;
	
	
	/**
	 * @deprecated replaced by {@link IBlockingConnection#setReadTimeoutMillis(int)
	 */
	int getReceiveTimeoutMillis() throws IOException;
	



	/**
	 * @deprecated replaced py {@link IBlockingConnection#suspendReceiving()}
	 */
	...
	/**
	 * @deprecated replaced by {@link IBlockingConnection#resumeReceiving()}
	 */
	...
	/**
	 * @deprecated replaced by {@link IBlockingConnection#isReceivingSuspended()}
	 */
