...
public final class QAUtil {
	...
	public static String getNameTestfile_4k() {
		...
		if (url != null) {
		    try {
                ...
                filename = createTempfile(is, ".html");
                is.close();
            } catch (IOException e) {
	...
	public static String getNameTestfile_800k() {
        String filename = null;
	...
	private static String createTempfile(InputStream is, String suffix) throws IOException {
