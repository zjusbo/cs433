 ...
 * Ifa connection is requested and the max limit of the active connection
...
public interface IConnectionPool extends Closeable {
	...
	public static final long DEFAULT_MAX_WAIT_MILLIS = 3L * 60L * 1000L;
   ...
   /**
     * return the max number of waiting requests
     * 
     * @return the max number of waiting requests
     */
    int getMaxWaiting();
    ...
    /**
     * set the max number of waiting requests
     * @param maxWaiting the max number of waiting requests
     */
