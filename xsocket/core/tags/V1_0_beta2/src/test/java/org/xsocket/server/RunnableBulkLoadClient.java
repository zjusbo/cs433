// $Id: RunnableBulkLoadClient.java 450 2006-12-09 07:06:47Z grro $
/*
...
public final class RunnableBulkLoadClient {
	...
	public void launch(final String host, final int port, final int countThreads, final int dataSizeInBytes) {
		...
		System.out.println("starting with " + countThreads + " threads and " + TextUtils.printFormatedBytesSize(dataSizeInBytes) + " data package");
