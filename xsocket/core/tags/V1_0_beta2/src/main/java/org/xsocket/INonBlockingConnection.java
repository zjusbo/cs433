// $Id: INonBlockingConnection.java 439 2006-12-06 06:43:30Z grro $
/*
...
public interface INonBlockingConnection extends IConnection {
	 ...
	 * @throws IOException If some other I/O error occurs
	 */
	public String readStringByDelimiter(String delimiter) throws IOException, ClosedConnectionException, BufferUnderflowException;
	 ...
	 * @throws IOException If some other I/O error occurs
	 */
	public String readStringByDelimiter(String delimiter, String encoding) throws IOException, ClosedConnectionException, BufferUnderflowException;
