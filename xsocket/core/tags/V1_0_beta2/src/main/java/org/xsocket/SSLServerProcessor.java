// $Id: SSLServerProcessor.java 438 2006-12-05 17:12:12Z grro $
/*
 ...
 */
final class SSLServerProcessor extends SSLProcessor {
	 ...
	 */
	SSLServerProcessor(Connection connection, SSLContext sslContext) {
