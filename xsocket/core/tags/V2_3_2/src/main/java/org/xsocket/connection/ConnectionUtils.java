...
public final class ConnectionUtils {
	...
	static final class HandlerInfo {
	    ...
	    private boolean isHandlerUnsynchronized = false;
		...
		HandlerInfo(IHandler handler) {
			...
			isHandlerUnsynchronized = (handler instanceof IUnsynchronized);
            ...
            isNonThreaded = !isHandlerMultithreaded && !isConnectHandlerMultithreaded && 
                            ...
                            !isConnectExceptionHandlerMultithreaded;
        }
		...
		public boolean isHandlerUnsynchronized() {
		    return isHandlerUnsynchronized;
		}
	...
	static final class CompletionHandlerInfo {
        ...
        public CompletionHandlerInfo(IWriteCompletionHandler handler) {
            ...
            if (IUnsynchronized.class.isAssignableFrom(handler.getClass())) {
