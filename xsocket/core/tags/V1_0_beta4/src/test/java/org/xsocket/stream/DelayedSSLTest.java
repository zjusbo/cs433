// $Id: DelayedSSLTest.java 899 2007-02-11 13:49:26Z grro $
/*
...
public final class DelayedSSLTest {
	...
	@Test public void testXSocket() throws Exception {
		...
		TestUtil.assertTimeout(System.currentTimeMillis() - start, 1800, 3700);  // 6 bytes / 3 bytesSec -> 2 sec 
		...
		TestUtil.assertTimeout(System.currentTimeMillis() - start, 2000, 3800);  // 7 bytes / 3 bytesSec -> 2,3 sec
