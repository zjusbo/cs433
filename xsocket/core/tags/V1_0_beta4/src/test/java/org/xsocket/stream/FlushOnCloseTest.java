// $Id: FlushOnCloseTest.java 899 2007-02-11 13:49:26Z grro $
/*
...
public final class FlushOnCloseTest {
	...
	@Test public void testSimple() throws Exception {
		...
		Assert.assertTrue(connection.readStringByDelimiter(DELIMITER).equals(OK_RESPONSE));
		...
		Assert.assertTrue(connection.readStringByDelimiter(DELIMITER).equals(CLOSED_RESPONSE));
