// $Id: ChainedRecordsCallTest.java 899 2007-02-11 13:49:26Z grro $
/*
...
public final class ChainedRecordsCallTest {
	...
	@Test public void testSimple() throws Exception {
		...
		String response = bc.readStringByDelimiter(DELIMITER);
		Assert.assertEquals(request, response);
		
		response = bc.readStringByDelimiter(DELIMITER);
		Assert.assertEquals(request, response);
	...
	private class Handler implements IDataHandler {
