...
public interface INonBlockingConnection extends IConnection, IDataSource, IDataSink, GatheringByteChannel, ReadableByteChannel, WritableByteChannel, Flushable {
	...
	/**
	 * @deprecated replaced py {@link INonBlockingConnection#suspendReceiving()}
	 */
	...
	/**
	 * @deprecated replaced by {@link INonBlockingConnection#resumeReceiving()}
	 */
	...
	/**
	 * @deprecated replaced by {@link INonBlockingConnection#isReceivingSuspended()}
	 */
...
//	public void setReadTransferRate(int bytesPerSecond) throws ClosedChannelException, IOException;
	 ...
	 *   ReadableByteChannel fc = new RandomAccessFile(file, "r").getChannel();
	 *  
