...
/**
 * implementation of the {@link IDispatcher} <br><br>
...
public class Dispatcher<T extends IHandle> implements IDispatcher<T> {
	...
	// event handler
	private IDispatcherEventHandler<T> eventHandler = null;
	 ...
	 */
	public Dispatcher(IDispatcherEventHandler<T> eventHandler)  {
	 ...
	 * {@inheritDoc}
	 */
	public final IDispatcherEventHandler<T> getEventHandler() {
		return eventHandler;
	}
