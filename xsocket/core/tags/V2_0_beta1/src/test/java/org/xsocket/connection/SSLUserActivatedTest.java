...
public final class SSLUserActivatedTest {
	...
	public void testRepeatedActivation() throws Exception {
		IServer sslTestServer = new Server(0, new SSLHandlerRepeatedActivation(), SSLTestContextFactory.getSSLContext(), false);
	...
	//	QAUtil.setLogLevel("org.xsocket.stream.spi.IoSocketHandler", Level.FINE);
