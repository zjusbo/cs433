// $Id: INonBlockingConnection.java 1754 2007-09-22 15:56:25Z grro $
/*
...
public interface INonBlockingConnection extends IConnection {
	...
	/**
	 * transfers all received byte buffers. In the case the delimiter has been
	 ...
	 * method. In this case the method returns false; <br>
	 ...
	 * @throws IOException If some other I/O error occurs
	 */
	public TransferResult transferAvailableByDelimiter(String delimiter, WritableByteChannel outputChannel) throws IOException;
	 ...
	 * @throws IOException If some other I/O error occurs
	 */
	public TransferResult transferAvailableByDelimiter(String delimiter, String encoding, WritableByteChannel outputChannel) throws IOException;
	...
	/**
	 * read all available ByteBuffer by using a delimiter
	 * <br>
     * For performance reasons, the ByteBuffer readByteBuffer method is
     * generally preferable to get bytes
	 *
	...
	/**
	 * read all received byte arrays by using a delimiter
	 * <br>
     * For performance reasons, the ByteBuffer readByteBuffer method is
     * generally preferable to get bytes
	 *
	...
	/**
	 * read all available strings by using a delimiter and the connection default encoding
	 *
	 * @param delimiter   the delimiter
	 * @return the strings
	 * @throws IOException If some other I/O error occurs
