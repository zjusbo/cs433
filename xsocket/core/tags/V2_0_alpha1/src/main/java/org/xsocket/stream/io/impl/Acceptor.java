...
final class Acceptor implements IAcceptor {
    ...
    void resetStatistics() {
    	...
    	dispatcherPool.resetStatistics();
    }
    ...
    public IIoSocketDispatcherMXBean[] getIoSocketDispatcher() {
    	List<IDispatcher<IoSocketHandler>> dispatcher = dispatcherPool.getDispatchers();
        return dispatcher.toArray(new IIoSocketDispatcherMXBean[dispatcher.size()]);
    }
    ...
    public List<IoSocketHandler> getOpenConnections() {
        List<IoSocketHandler> result = new ArrayList<IoSocketHandler>();
