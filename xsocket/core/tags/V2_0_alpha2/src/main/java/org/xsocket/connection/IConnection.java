...
public interface IConnection extends Closeable {
	...
	public static final int MAX_TIMEOUT_SEC = Integer.MAX_VALUE;
	public static final int DEFAULT_CONNECTION_TIMEOUT_SEC = MAX_TIMEOUT_SEC;
	public static final int DEFAULT_IDLE_TIMEOUT_SEC = MAX_TIMEOUT_SEC;
