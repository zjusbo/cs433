...
public final class EchoServer implements Closeable {
	...
	@Execution(Execution.Mode.NONTHREADED) // performance improvement, but don't set to 'single threaded' mode if long running (I/O, network) operations will be performed within onData 
	private static final class EchoHandler implements IDataHandler {

		public boolean onData(INonBlockingConnection connection) throws IOException, BufferUnderflowException, MaxReadSizeExceededException {
			ByteBuffer[] data = connection.readAvailableByteBuffer();
