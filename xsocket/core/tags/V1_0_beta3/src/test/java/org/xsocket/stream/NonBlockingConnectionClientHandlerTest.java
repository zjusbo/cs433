// $Id: NonBlockingConnectionClientHandlerTest.java 764 2007-01-15 06:26:17Z grro $
/*
...
public final class NonBlockingConnectionClientHandlerTest {
	...
	@Test public void testDataHandler() throws Exception {
		...
		INonBlockingConnection connection = new NonBlockingConnection("127.0.0.1", testServer.getLocalPort(), clientDataHandler, 1);
