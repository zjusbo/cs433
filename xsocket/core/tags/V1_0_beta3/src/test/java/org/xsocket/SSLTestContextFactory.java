// $Id: SSLTestContextFactory.java 775 2007-01-15 16:44:47Z grro $
/*
		...
		try {
			...
			if (keystoreUrl != null) {
				...
				filename = new File("src" + File.separator + "test" + File.separator 
						           ...
						           + "xsocket" + File.separator + "keystore.db").getAbsolutePath();
			}
			...
			System.out.println("keystoredb found " + filename.toString());
