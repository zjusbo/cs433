// $Id: DelayedSSLTest.java 764 2007-01-15 06:26:17Z grro $
/*
...
public final class DelayedSSLTest {
	...
	@Test public void testXSocket() throws Exception {
		...
		IMultithreadedServer sslTestServer = new MultithreadedServer(0, new SSLHandler(), "SSLTestSrv", true, new SSLTestContextFactory().getSSLContext());
		...
		TestUtil.assertTimeout(System.currentTimeMillis() - start, 1800, 2700);  // 6 bytes / 3 bytesSec -> 2 sec 
		...
		TestUtil.assertTimeout(System.currentTimeMillis() - start, 2000, 2800);  // 7 bytes / 3 bytesSec -> 2,3 sec
