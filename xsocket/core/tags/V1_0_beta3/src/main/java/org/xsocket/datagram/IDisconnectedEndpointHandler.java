// $Id: IDisconnectedEndpointHandler.java 778 2007-01-16 07:13:20Z grro $
/*
...
/**
 * a disconnected endpoint handler
 * 
 * @author grro@xsocket.org
 */
public interface IDisconnectedEndpointHandler {


	
	/**
	 * call back method for received data 
     * 
	 * @param endpoint       the local endpoint
	 * @param data           the received data 
	 * @param remoteAddress  the address of the remote host
	 * @return true, if data has been handled
