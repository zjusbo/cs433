// $Id: IDisconnectHandler.java 1049 2007-03-21 16:42:48Z grro $
/*
 ...
 *   <li> the connection breaks or the client disconnects improperly and the underlying SocketChannel 
 *        doesn't detect the broken connection. In this case the <code>onDisconnect</code> method 
 *        will only be called after a connection or idle timeout (see {@link ITimeoutHandler}) 
 * </ul>
 * 
 * 
