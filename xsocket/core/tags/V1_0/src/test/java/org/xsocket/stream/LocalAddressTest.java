// $Id: LocalAddressTest.java 1032 2007-03-18 11:32:34Z grro $
/*
...
public final class LocalAddressTest  {
	...
	@Test public void testSimple() throws Exception {
		...
		for (int i = 0; i < 30; i++)  {
			IMultithreadedServer server = new MultithreadedServer(TestUtil.getRandomLocalAddress(), 0, new Handler());
