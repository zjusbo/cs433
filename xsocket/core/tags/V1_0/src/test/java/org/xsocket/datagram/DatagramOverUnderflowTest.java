// $Id: DatagramOverUnderflowTest.java 1042 2007-03-20 17:57:07Z grro $
/*
...
public final class DatagramOverUnderflowTest {
	...
	@Test public void testPacketWriteOverflow() throws Exception {		
		Handler hdl = new Handler();
		IEndpoint serverEndpoint = new Endpoint(SIZE, hdl);
		IConnectedEndpoint clientEndpoint = new ConnectedEndpoint(serverEndpoint.getLocalSocketAddress(), SIZE);
	...
	@Test public void testPacketPreSetOverflow() throws Exception {		
		Handler hdl = new Handler();
		IEndpoint serverEndpoint = new Endpoint(SIZE, hdl);
		IConnectedEndpoint clientEndpoint = new ConnectedEndpoint(serverEndpoint.getLocalSocketAddress(), SIZE);
		...
		Assert.assertTrue(TestUtil.isEquals(data, response));
