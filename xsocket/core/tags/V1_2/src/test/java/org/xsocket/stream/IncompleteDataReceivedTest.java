...
public final class IncompleteDataReceivedTest  {
	...
	public void testDelimiter() throws Exception {
		...
		INonBlockingConnection connection = new NonBlockingConnection(server.getLocalAddress(), server.getLocalPort(), cltHdl);
		QAUtil.sleep(200);
		...
		INonBlockingConnection connection2 = new NonBlockingConnection(server.getLocalAddress(), server.getLocalPort(), cltHdl2);
		QAUtil.sleep(200);
		...
		INonBlockingConnection connection3 = new NonBlockingConnection(server.getLocalAddress(), server.getLocalPort(), cltHdl3);
		QAUtil.sleep(200);
