// $Id: BlockingConnectionTest.java 1579 2007-07-30 05:47:31Z grro $
/*
...
public final class BlockingConnectionTest {
	...
	public void testAsyncServerSide() throws Exception {
		perform(new MultithreadedServer(new AsyncHandler()));
	}
	...
	public void testSyncServerSide() throws Exception {
		perform(new MultithreadedServer(new SyncHandler()));
	}

	
	
	private void perform(final IMultithreadedServer server) throws Exception {
