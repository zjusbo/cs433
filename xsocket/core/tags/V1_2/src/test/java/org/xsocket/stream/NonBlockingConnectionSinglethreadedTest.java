...
public final class NonBlockingConnectionSinglethreadedTest {
	...
	public void testSingleThreaded() throws Exception {
		...
		INonBlockingConnection connection = new NonBlockingConnection(server.getLocalAddress(), server.getLocalPort(), clHdl, null);
	...
	public void testDefaultThreaded() throws Exception {
		...
		ClientHandler clHdl = new ClientHandler();
		INonBlockingConnection connection = new NonBlockingConnection(server.getLocalAddress(), server.getLocalPort(), clHdl);
