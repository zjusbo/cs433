// $Id: MarkAndResetTest.java 1333 2007-06-15 16:19:26Z grro $
/*
...
public final class MarkAndResetWithDelimiterTest {
    ...
    public void testMark() throws Exception {
        ...
        IMultithreadedServer server = new MultithreadedServer(handler);
        StreamUtils.start(server);
        
        SocketChannel channel = SocketChannel.open();
        channel.connect(new InetSocketAddress(server.getLocalAddress(), server.getLocalPort()));
