// $Id: LargeDataTransferTest.java 1449 2007-07-04 16:06:49Z grro $
/*
...
public final class LargeDataTransferTest  {
	...
	public void testByLength() throws Exception {
		IMultithreadedServer server = new MultithreadedServer(new LengthHandler());
	...
	public void testByDelimiter() throws Exception {
		IMultithreadedServer server = new MultithreadedServer(new DelimiterHandler());
		StreamUtils.start(server);
