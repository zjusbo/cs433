// $Id: ByteBufferQueue.java 1184 2007-04-25 06:32:22Z grro $
/*
...
final class ByteBufferQueue {
	...
	/**
	 * return a int, which represent the modify version.
	 * this value will increase with each modification (insert, remove)
	 * 
	...
	public String toString() {
		...
		if (buffers != null) {
			...
			sb.append("\r\n" + DataConverter.toTextAndHexString(copy, "US-ASCII", 500));
		}
	...
	/**
	 * return the queue content as hex string
	 * @return the hex string
	 */
	String toTextOrHexString() {
		if (buffers == null) {
			return "";
		} else {
			ByteBuffer[] copy = new ByteBuffer[buffers.size()];
			...
			return DataConverter.toTextOrHexString(copy, "UTF-8", 5000);
		}
	}
}
