...
public class ReadByteBufferTest {
	...
	@Test public void testBlockingConnection() throws Exception {
	...
	@Test public void testBlockingNoBytesConnection() throws Exception {
	...
	@Test public void testNonBlockingConnection() throws Exception {
		IMultithreadedServer server = new MultithreadedServer(new Handler());
		StreamUtils.start(server);
