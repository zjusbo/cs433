...
public final class DataTypesTest extends AbstractServerTest {
	...
	public DataTypesTest() {
		super(7312, new DataTypesTestServerHandler(), 1, 1, 3);
	}
	...
	@Test public void testMixed() throws Exception {
		...
		IBlockingConnection connection = new BlockingConnection(SocketChannel.open(new InetSocketAddress("127.0.0.1", getServerPort())), 3);
	...
	private static class DataTypesTestServerHandler implements IDataHandler, IConnectHandler, IConnectionScoped {
		...
		public boolean onData(INonBlockingConnection connection) throws IOException {
			...
			case 3:
				String s1 = connection.readWord("\r\n");
				Assert.assertEquals(s1, "");
				state = 4;
				break;
				
			case 4:
				String s2 = connection.readWord("tt");
