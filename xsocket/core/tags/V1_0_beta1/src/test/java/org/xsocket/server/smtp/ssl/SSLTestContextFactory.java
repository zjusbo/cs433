...
*/
public final class SSLTestContextFactory implements ISSLContextFactory {
		...
		try {
			...
			if (keystoreUrl != null) {
				...
				filename = new File("src" + File.separator + "test" + File.separator 
						           ...
						           + "xsocket" + File.separator + "server" + File.separator
						           + "smtp" + File.separator + "ssl" + File.separator
