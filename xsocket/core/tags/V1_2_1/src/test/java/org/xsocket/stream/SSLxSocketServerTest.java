...
public final class SSLxSocketServerTest {
	...
	public void testSSLClient() throws Exception {
		...
		IMultithreadedServer sslTestServer = new MultithreadedServer(0, new SSLHandler(), true, SSLTestContextFactory.getSSLContext());
	...
	public void testLengthField() throws Exception {
		MultithreadedServer server = new MultithreadedServer(0, new LengthFieldHandler(), true, SSLTestContextFactory.getSSLContext());
