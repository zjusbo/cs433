...
public final class SSLxSocketClientTest {
	...
	public void testBlocking() throws Exception {
		...
		IBlockingConnection connection = new BlockingConnection("127.0.0.1", server.getLocalPort(), SSLTestContextFactory.getSSLContext(), true);
	...
	public void testNonBlocking() throws Exception {
		...
		INonBlockingConnection connection = new NonBlockingConnection("127.0.0.1", server.getLocalPort(), SSLTestContextFactory.getSSLContext(), true);
