...
public final class Proxy implements Closeable {
	...
	private static class ProxyHandler implements IConnectHandler, IDataHandler, IDisconnectHandler {
		...
		public boolean onDisconnect(INonBlockingConnection connection) throws IOException {
			INonBlockingConnection reverseConnection = (INonBlockingConnection) connection.attachment();
		...
		public boolean onData(INonBlockingConnection connection) throws IOException, BufferUnderflowException, MaxReadSizeExceededException {
			INonBlockingConnection forwardConnection = (INonBlockingConnection) connection.attachment();
