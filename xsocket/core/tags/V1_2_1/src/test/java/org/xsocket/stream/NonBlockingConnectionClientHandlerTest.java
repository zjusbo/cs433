// $Id: NonBlockingConnectionClientHandlerTest.java 1769 2007-09-26 07:24:59Z grro $
/*
...
public final class NonBlockingConnectionClientHandlerTest {
	...
	public void testChainTest() throws Exception {
		...
		INonBlockingConnection connection = new NonBlockingConnection("localhost", testServer.getLocalPort(), chain);
		connection.setAutoflush(true);
		QAUtil.sleep(100);
	...
	public void testCustomWorkerPool() throws Exception {
		...
		INonBlockingConnection connection = new NonBlockingConnection(InetAddress.getByName("localhost"), testServer.getLocalPort(), clientDataHandler, workerPool);
		connection.setAutoflush(true);
