...
public final class Example {
	...
	public void testSimple() throws Exception {
		...
		System.setProperty(IServerIoProvider.PROVIDER_CLASSNAME_KEY, ServerIoProvider.class.getName());
		
		
		// the remaing stay the same 
		Handler handler = new Handler();
		IMultithreadedServer server = new MultithreadedServer(0, handler, Executors.newCachedThreadPool());
	...
	public void testSingleThreaded() throws Exception {
		...
		Handler handler = new Handler();
		IMultithreadedServer server = new MultithreadedServer(0, handler, null);
		StreamUtils.start(server);
