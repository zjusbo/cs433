...
public final class SocketOptionsTest {
	...
	public void testConnectedEndpoint() throws Exception {
		...
		ConnectedEndpoint clientEndpoint = new ConnectedEndpoint(new InetSocketAddress("localhost", serverEndpoint.getLocalPort()), socketConf, packageSize, new EchoHandler());
