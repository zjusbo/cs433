 ...
 * when this method will be call. Please note, that on network level
...
public interface IDataHandler extends IHandler {
	 ...
	 * immediately. In this case the <code>isOpen</code> call within the <code>onData</code>
	 * Method will return false. Reading of already received data would not fail.
