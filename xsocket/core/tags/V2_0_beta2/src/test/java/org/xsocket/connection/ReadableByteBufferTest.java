...
public final class ReadableByteBufferTest {
	...
	public void testSimple() throws Exception {
		...
		try {
			i = nbc.read(buffer);
			Assert.fail("ClosedChannelException exepcted");
		}  catch (ClosedChannelException exepcted) { }
	}
	...
	public void testHttp() throws Exception {
		...
		System.out.println("this test could take a while if the connection is persistent (test is terminated by http connection timeout)");
