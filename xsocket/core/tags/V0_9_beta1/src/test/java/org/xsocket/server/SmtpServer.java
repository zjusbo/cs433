...
public final class SmtpServer {
	...
	public void launch(int port) throws Exception {
		...
		ss = new MultithreadedServer(port, "TestSrv");
		ss.setDispatcherSize(6);
		ss.setDispatcherWorkerSize(4);
		ss.setReceiveBufferPreallocationSize(512);
	...
	private class BlackIpHandler implements IConnectHandler {
	...
	private class FirstConnectionRefuser implements IConnectHandler {		
