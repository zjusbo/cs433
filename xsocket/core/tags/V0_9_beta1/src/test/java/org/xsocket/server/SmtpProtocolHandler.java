...
final class SmtpProtocolHandler implements IConnectHandler, IDataHandler, IConnectionScoped {
	...
	private void sendResponse(String s, IConnection connection) throws IOException {
		String response = s + "   " + connection.getId() +  "; " + Thread.currentThread().getId() + " \r\n";
